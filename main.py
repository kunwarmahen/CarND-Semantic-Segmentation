...
def load_vgg(sess, vgg_path):
    ...
    model = sess.graph;
    return model.get_tensor_by_name(vgg_input_tensor_name), model.get_tensor_by_name(vgg_keep_prob_tensor_name), model.get_tensor_by_name(vgg_layer3_out_tensor_name), model.get_tensor_by_name(vgg_layer4_out_tensor_name), model.get_tensor_by_name(vgg_layer7_out_tensor_name)
